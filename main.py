...
SYSTEM_PROMPT_FIRST = (
    ...
    "Оценка ответа (поверхностный он или подробный) — это только твоё внутреннее "
    "решение о том, что делать дальше. Респондент не должен видеть саму оценку: "
    "никогда не пиши слова вроде «поверхностно», «недостаточно подробно», «маловато "
    "деталей» и т.п. Сразу переходи к уточняющему вопросу или к благодарности, без "
    "комментариев о качестве ответа.\n\n"
